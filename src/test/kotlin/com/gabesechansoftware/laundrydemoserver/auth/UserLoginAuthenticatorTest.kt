...
class UserLoginAuthenticatorTest {
    ...
    @InjectMockKs
    private lateinit var authService: UserLoginAuthenticator
    ...
    fun `createSession - saves and returns a user session`() {
        ...
        val service = UserLoginAuthenticator(passwordRepo = passwordRepo, sessionRepository = sessionRepository, timeSource = timeSource)
    ...
    fun `createPasswordForUser-  password is saved, in an encoded form`() {
        ...
        val service = UserLoginAuthenticator(passwordRepo = passwordRepo, sessionRepository = sessionRepository, encoder = encoder)
    ...
    fun `createPasswordForUser-  invalid password throws APIException`() {
        ...
        val service = UserLoginAuthenticator(passwordRepo = passwordRepo, sessionRepository = sessionRepository, passwordValidator = validator)
